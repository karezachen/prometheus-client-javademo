...
public class MyExporter {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] cipherSuites = {"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256", "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384"};
		sslContextFactory.setIncludeCipherSuites(cipherSuites);
		String[] excludedCipherSuites = {"TLS_RSA_WITH_AES_128_CBC_SHA"};
